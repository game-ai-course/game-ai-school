...
class State:
    ...
    def moves(self):
        ...
        Реализация:
        Из каждого ещё не посещённого тайла запустить поиск в ширину (метод bfs ниже) по тайлам того же цвета.
        """
        pass


    def bfs(self, x0, y0, visited):
        """
        Поиск в ширину.

        Реализация:
            На вход: стартовый тайл (x0, y0), список посещенных visited
